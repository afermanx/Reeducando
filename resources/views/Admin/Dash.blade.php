        ...
        <div class="row m-0 align-items-center">
            <div class="col-lg-12 col-md-12 p-0 text-center" >
                <div class="welcome-content">
                    <h1 class="mb-2">Ola, Bem vindo  {{$user->name}}</h1>
...
{{--                                     title="James Anderson" alt="image">--}}
