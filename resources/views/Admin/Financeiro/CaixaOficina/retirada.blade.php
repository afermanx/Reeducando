...
@section('breadName','Caixa - '.$cxOficina->name)<!--Destaque do mapa de url-->
@section('breadItem','Financeiro')<!--Meio do mapa-->
@section('breadcrumb')
    <li class="item">Caixa</li><!--Pagina atual-->
    <li class="item">{{$cxOficina->name}}</li><!--Pagina atual-->
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 ">
                <div class="single-stats-card-box">
                    ...
                    <span class="sub-title">Valor em caixa da</span>
                    <h3>R$ {{number_format( $cxOficina->valor ,2,",",".")}} </h3>
                </div>
                <br>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    ...
                    <tbody>
                    @foreach($oficinaRetiradas as $oficinaRetirada)

                        <tr>
                            <td class="text-center">{{(new DateTime($oficinaRetirada->updated_at))->format('d/m/Y')}}</td>
                            <td class="font-w600">
                                <a href="">{{$oficinaRetirada->description}}</a>
                            </td>
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">{{$oficinaRetirada->valor}}</em>
                            </td>
                            <td class="d-none d-sm-table-cell">
...
@section('jsAdmin')
    ...
    <script>
        ...
        function retirar(id, valorOficina) {
                ...
                success: function (data) {
                    ...
                    if (retorno['sucesso'] === false) {
                        ...
                        Swal.fire({
                            ...
                            timer: 1500,
                            onClose: () => {
                                $(location).attr('href', '/caixa/oficina/retirada/'+id)
                            }
                        })
                    }
